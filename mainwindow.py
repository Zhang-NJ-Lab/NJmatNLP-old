...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuchemdataextractor = QtWidgets.QMenu(self.menubar)
        self.menuchemdataextractor.setObjectName("menuchemdataextractor")
        ...
        self.actioncsv_clean = QtWidgets.QAction(MainWindow)
        self.actioncsv_clean.setObjectName("actioncsv_clean")
        ...
        self.menuchemdataextractor.addAction(self.actioncsv_clean)
        self.menubar.addAction(self.menuSave_path.menuAction())
        self.menubar.addAction(self.menumatbert_model.menuAction())
        self.menubar.addAction(self.menuchemdataextractor.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuchemdataextractor.setTitle(_translate("MainWindow", "chemdataextractor"))
        ...
        self.actioncsv_clean.setText(_translate("MainWindow", "csv clean"))
